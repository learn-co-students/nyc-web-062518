...
instructors = [
  {name: 'Graham', hometown: 'Oak Park, IL', mood: 'Haim'},
  {name: 'Elbin', hometown: 'Staten Island, NY'},
  {name: 'Matt', hometwon: 'Tampa'}
]
#
def get_names(instructors)
  array_of_stuff = instructors.map do |instructor_hash|
