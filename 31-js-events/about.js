...
document.getElementById("box-8").addEventListener("mouseover", () => console.log("whooooo"));
...
eventDescriptors.forEach(eventDesc => {
  // debugger
  document.getElementById(eventDesc.id).addEventListener("click", clickHandler);
});
